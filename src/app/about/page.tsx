    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-16 section-divider">
                ...
                <h1 className="text-4xl font-bold font-[family-name:var(--font-heading)] text-[var(--color-foreground)] heading-accent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <div className="rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] p-6 text-center">
                    ...
                    <h3 className="font-bold font-[family-name:var(--font-heading)] mb-3">{t('300+ Destinations', '300+ وجهة')}</h3>
                ...
                <div className="rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] p-6 text-center">
                    ...
                    <h3 className="font-bold font-[family-name:var(--font-heading)] mb-3">{t('Smart Planning', 'تخطيط ذكي')}</h3>
                    <p className="text-sm text-[var(--color-muted)]">
                        {t(
                ...
                <div className="rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] p-6 text-center">
                    ...
                    <h3 className="font-bold font-[family-name:var(--font-heading)] mb-3">{t('Modern Tech', 'تقنية حديثة')}</h3>
                    <p className="text-sm text-[var(--color-muted)]">
                        {t(
